...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/XAML-0C54C2?style=for-the-badge&logo=microsoft&logoColor=white"/>
...
* the project is obfuscated
* the application uses networking and synchronization
* the build is currently unsigned

If you are unsure about the file, you are free to:

* scan the application yourself
